...
begin
  ...
  if TipoMov = 0 then
    NovoSaldo := SaldoAtual - ValorMov
  else
    NovoSaldo := SaldoAtual + ValorMov;

  DataModule1.qryInserirMovimentacao.Close;
  DataModule1.qryInserirMovimentacao.ParamByName('CARD').AsInteger := CodigoCard;
  DataModule1.qryInserirMovimentacao.ParamByName('SERVICO').AsInteger := CodigoServico;
  DataModule1.qryInserirMovimentacao.ParamByName('TIPO').AsInteger := TipoMov;
  DataModule1.qryInserirMovimentacao.ParamByName('VALOR').AsCurrency := ValorMov;
  DataModule1.qryInserirMovimentacao.ParamByName('DATA').AsDate := Date;
  DataModule1.qryInserirMovimentacao.ExecSQL;

  DataModule1.qryAtualizaSaldo.Close;
  DataModule1.qryAtualizaSaldo.ParamByName('CODIGO').AsInteger := CodigoCard;
  DataModule1.qryAtualizaSaldo.ParamByName('VALOR').AsCurrency := NovoSaldo;
  DataModule1.qryAtualizaSaldo.ExecSQL;
